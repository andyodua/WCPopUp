...
class Wcpopup_Loader {
	...
	public function __construct() {
		$this->define( "WCPOPUP_PLUGIN_BASENAME", plugin_basename( WCPOPUP_PLUGIN_FILE ) );
		$this->define( "WCPOPUP_PATH", plugin_dir_path( WCPOPUP_PLUGIN_FILE ) ); // Plugin path
		$this->actions = array();
		$this->filters = array();
		$this->includes();
	}
	...
	*/
	...
	public function add_shortcode( $hook, $component, $callback, $priority = 10, $accepted_args = 1 ) {
		$this->shortcode = $this->add( $this->filters, $hook, $component, $callback, $priority, $accepted_args );
	}
	/**
